...
public class CommentApiController {
	...
	public CommentResponse saveComment(@PathVariable(value = "postId") final Long postId,
    ...
    public CommentResponse findCommentById(@PathVariable(value = "postId") final Long postId, @PathVariable(value = "id") final Long id) {
        return commentService.findCommentById(id);
    }
